export default {
  ...
  /** 获取商户列表 */
  getMerchants: `select id, name, phone, address, area_name areaName, logo, distribution_fee distributionFee, start_distribution_fee startDistributionFee, distribution_time distributionTime, distance, ifnull(month_sale, 0) monthSale, score, status, addtime, modifytime 
  ...
  /** 获取商户 */
  getMerchant: `select id, name, phone, address, province_id provinceId, city_id cityId, area_id areaId, area_name areaName, password, logo, distribution_fee distributionFee, start_distribution_fee startDistributionFee, distribution_time distributionTime, distance, audit_remark auditRemark, ifnull(month_sale, 0) monthSale, score, status, addtime, modifytime 
                from e_merchant left join (select merchant_id, count(merchant_id) month_sale from e_order group by merchant_id) month_sale on e_merchant.id = month_sale.merchant_id 
