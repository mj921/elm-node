export default {
  ...
  /** 获取商户列表 */
  getMerchants: "select id, name, phone, address, area_name areaName, logo, distribution_fee distributionFee, start_distribution_fee startDistributionFee, distribution_time distributionTime, distance, status, addtime, modifytime from e_merchant where name like ? and (true = ? or status = ?) and deleted = 0 limit ?, ?",
  /** 获取商户总数 */
